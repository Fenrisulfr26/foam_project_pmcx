...
def fitfn(cfg, mu_a, mu_s):
    ...
    for i, posy in enumerate([100, 125, 150]):
        for j, posx in enumerate([100, 125, 150]):
    ...
    conv = np.flip(conv,axis = 1) # flip left-right to fit the results
